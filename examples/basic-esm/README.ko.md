...
이 예제는 **ES Modules (ESM)** 방식으로 express-numflow를 사용하는 방법을 보여줍니다.

## 특징

- ✅ ES Modules (`import`/`export`)
- ✅ `package.json` imports 필드를 사용한 Short Path 설정
- ✅ Node.js로 직접 실행 (별도 transpile 불필요)
- ✅ Feature-First 아키텍처
- ✅ Sequential Steps 패턴
...
## Short Path 설정 (package.json imports)
...
**주의사항**:
- `"type": "module"` 필수
- Short path는 `#`로 시작 (Node.js >= 14.6 권장)
- 파일 확장자 `.js` 생략 가능
...
```
basic-esm/
├── package.json          # "type": "module" + imports 설정
├── app.js                # Express 서버
